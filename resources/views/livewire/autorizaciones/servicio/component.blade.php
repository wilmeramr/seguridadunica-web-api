<div class="row sales layout-top-spacing">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="text-center">
                            <h6>{{$autorizacion->tipo_autorizacion}} {{$autorizacion->stp_descripcion}}</h6>
                        </td>
                        <td class="text-center">
   ...
   @include('livewire.autorizaciones.servicio.form')
   @include('livewire.autorizaciones.servicio.details')
