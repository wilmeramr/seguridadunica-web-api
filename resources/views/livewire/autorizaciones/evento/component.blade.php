<div class="row sales layout-top-spacing">
            ...
            <div class="table-responsive">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                           <h6> {{\Carbon\Carbon::parse($autorizacion->aut_fecha_evento)->format('d-m-Y H:i')}}</h6>
                        </td>
                        <td class="text-center">
                            <h6> {{\Carbon\Carbon::parse($autorizacion->aut_fecha_evento_hasta)->format('d-m-Y H:i')}}</h6>
                         </td>
                        <td>
   ...
   @include('livewire.autorizaciones.evento.form')
   @include('livewire.autorizaciones.evento.details')
